    ...
    Scaffold(
        ...
        topBar = {
            Row(
                ...
                Text(
                    stringResource(Res.string.guest_browse_title),
                ...
                if (domains.isNotEmpty()) {
                    item {
                        LazyRow(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            item {
                                TopicChip(stringResource(Res.string.guest_all), domain == null) { domain = null }
                            }
                            items(domains) { d ->
                        ...
                        AnimatedEntry(index = 1) {
                            Card(
                                ...
                                Column(Modifier.padding(24.dp)) {
                                    Text(
                                        stringResource(Res.string.guest_nothing_yet),
                                    ...
                                    OfflineEmpty(
                                        state,
                                        stringResource(Res.string.guest_nothing_yet_hint),
                                        color = Primary
                                    )
                                }
                            }
...
fun SignUpPrompt(onSignUp: () -> Unit, modifier: Modifier = Modifier) {
    Card(
        ...
        Column(Modifier.padding(20.dp)) {
            Text(
                stringResource(Res.string.guest_want_more),
                style = MaterialTheme.typography.titleMedium,
                color = Primary
            )
            Spacer(Modifier.height(6.dp))
            ...
            PrimaryButton(text = stringResource(Res.string.guest_create_free_account), onClick = onSignUp)
        }
    }
}
