package com.example.studyplatform.ui.screens.guides
    ...
    Scaffold(
        ...
        topBar = {
            Row(
                ...
                Text(stringResource(Res.string.guides_generate_title), style = MaterialTheme.typography.titleLarge, color = TextPrimary)
            }
        },
        ...
        Column(
            ...
            // Topic input
            Text(stringResource(Res.string.guides_what_learn), style = MaterialTheme.typography.titleMedium, color = TextPrimary)
            ...
            // Specific concept
            Text(stringResource(Res.string.guides_focus_area), style = MaterialTheme.typography.titleMedium, color = TextPrimary)
            Spacer(Modifier.height(10.dp))
            OutlinedTextField(
            ...
            // Expertise level
            Text(stringResource(Res.string.guides_your_level), style = MaterialTheme.typography.titleMedium, color = TextPrimary)
            Spacer(Modifier.height(10.dp))
            listOf(
            ...
            PrimaryButton(
                text = stringResource(Res.string.guides_generate_action),
...
private fun GeneratingLoadingScreen(jobStatus: String? = null) {
    ...
    Box(Modifier.fillMaxSize().background(Background), contentAlignment = Alignment.Center) {
        Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.padding(48.dp)) {
            ...
            Spacer(Modifier.height(24.dp))
            Text(stringResource(Res.string.guides_generating), style = MaterialTheme.typography.headlineSmall, color = TextPrimary, textAlign = TextAlign.Center)
            Spacer(Modifier.height(8.dp))
            Text(
                when (jobStatus) {
