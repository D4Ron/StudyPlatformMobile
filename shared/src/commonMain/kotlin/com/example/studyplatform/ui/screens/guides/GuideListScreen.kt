    ...
    Scaffold(
        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                ...
                text = { Text(stringResource(Res.string.guides_new), style = MaterialTheme.typography.labelLarge) }
            )
        }
    ) { padding ->
            ...
            LazyColumn(
                ...
                item {
                    AnimatedEntry {
                        Column {
                            Text(
                                stringResource(Res.string.guides_title),
                        ...
                        AnimatedEntry(index = 1) {
                            Card(
                                ...
                                Column(Modifier.padding(24.dp)) {
                                    Text(
                                        stringResource(Res.string.guides_none),
                                    ...
                                    OfflineEmpty(
                                        state,
                                        stringResource(Res.string.guides_none_hint),
                                        Modifier,
                                        color = Primary
                                    )
                                }
