package com.example.studyplatform.ui.screens.notes
        ...
        floatingActionButton = {
            AnimatedVisibility(
                ...
                ExtendedFloatingActionButton(
                    ...
                    text = { Text(stringResource(Res.string.notes_new), style = MaterialTheme.typography.labelLarge) }
                )
            }
        }
    ) { padding ->
                        ...
                        AnimatedEntry(index = 1) {
                            Card(
                                ...
                                Column(Modifier.padding(24.dp)) {
                                    Text(
                                        stringResource(Res.string.notes_none),
                                        style = MaterialTheme.typography.titleMedium,
                                        color = Primary
                                    )
                                    Spacer(Modifier.height(4.dp))
                                    Text(
                                        stringResource(Res.string.notes_none_hint),
...
private fun NoteForm(
    ...
    Card(
        ...
        Column(Modifier.padding(18.dp)) {
            Text(
                if (isEdit) stringResource(Res.string.notes_edit) else stringResource(Res.string.notes_new),
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(Res.string.notes_note_title)) },
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(Res.string.notes_content)) },
                modifier = Modifier.fillMaxWidth(),
                shape = MaterialTheme.shapes.small,
                minLines = 4,
                colors = OutlinedTextFieldDefaults.colors(
            ...
            Row(
                ...
                TextButton(onClick = onCancel) {
                    Text(stringResource(Res.string.common_cancel), color = TextMuted, style = MaterialTheme.typography.labelLarge)
                }
            }
        }
    }
        ...
        Column(Modifier.padding(16.dp)) {
            ...
            Row(
                ...
                if (note.sharedWithGroup) {
                    Text(
                        stringResource(Res.string.notes_shared_with_group),
                ...
                AnimatedVisibility(
                    ...
                    Text(
                        stringResource(Res.string.notes_saved_locally),
                        style = MaterialTheme.typography.labelSmall,
                        color = Warning
                    )
                }
