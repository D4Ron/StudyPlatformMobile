    ...
    Scaffold(
        ...
        topBar = {
            Row(
                ...
                Text(stringResource(Res.string.quizzes_generate_title), style = MaterialTheme.typography.titleLarge, color = TextPrimary)
            }
        },
        ...
        Column(
            ...
            Text(stringResource(Res.string.quizzes_what_topic), style = MaterialTheme.typography.titleMedium, color = TextPrimary)
            ...
            Text(stringResource(Res.string.quizzes_difficulty), style = MaterialTheme.typography.titleMedium, color = TextPrimary)
            Spacer(Modifier.height(10.dp))
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text(stringResource(Res.string.quizzes_questions_label), style = MaterialTheme.typography.titleMedium, color = TextPrimary)
            ...
            PrimaryButton(
                text = stringResource(Res.string.quizzes_generate_title),
...
private fun QuizLoadingScreen(jobStatus: String? = null) {
    ...
    Box(Modifier.fillMaxSize().background(Background), contentAlignment = Alignment.Center) {
        Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.padding(48.dp)) {
            ...
            Spacer(Modifier.height(24.dp))
            Text(stringResource(Res.string.quizzes_generating), style = MaterialTheme.typography.headlineSmall, color = TextPrimary, textAlign = TextAlign.Center)
            Spacer(Modifier.height(8.dp))
            Text(
                when (jobStatus) {
