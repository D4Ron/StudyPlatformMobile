    ...
    Scaffold(
        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                ...
                text = { Text(stringResource(Res.string.quizzes_new), style = MaterialTheme.typography.labelLarge) }
            )
        }
    ) { padding ->
            ...
            LazyColumn(
                ...
                item {
                    AnimatedEntry {
                        Column {
                            Text(
                                stringResource(Res.string.quizzes_title),
                        ...
                        AnimatedEntry(index = 1) {
                            Card(
                                ...
                                Column(Modifier.padding(24.dp)) {
                                    Text(
                                        stringResource(Res.string.quizzes_none),
                                    ...
                                    OfflineEmpty(
                                        state,
                                        stringResource(Res.string.quizzes_none_hint),
                                        Modifier,
                                        color = Secondary
                                    )
                                }
                        ...
                        Card(
                            ...
                            Column(Modifier.padding(16.dp)) {
                                ...
                                TextButton(
                                    ...
                                    Text(
                                        stringResource(Res.string.flashcards_open),
