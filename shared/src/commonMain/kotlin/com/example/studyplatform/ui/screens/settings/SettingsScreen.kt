package com.example.studyplatform.ui.screens.settings
...
fun SettingsScreen(onLogout: () -> Unit) {
    ...
    val syncFailedMessage = stringResource(Res.string.settings_sync_failed)
    val syncOkMessage = stringResource(Res.string.settings_sync_ok)
    ...
    Box(Modifier.fillMaxSize(), contentAlignment = Alignment.TopCenter) {
        Column(
            ...
            AnimatedEntry {
                Text(stringResource(Res.string.settings_title), style = MaterialTheme.typography.headlineLarge, color = TextPrimary)
            }
                ...
                Card(
                    ...
                    Row(Modifier.padding(20.dp), verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Column(Modifier.weight(1f)) {
                            Text(stringResource(Res.string.settings_sync), style = MaterialTheme.typography.titleMedium, color = TextPrimary)
                            Text(
                                lastResult ?: when {
                                    pending > 0L -> "$pending change(s) saved here, waiting to upload"
                                    else -> stringResource(Res.string.settings_sync_clean)
                                },
                        ...
                        TextButton(
                            ...
                            Text(
                                if (syncing) stringResource(Res.string.settings_syncing) else stringResource(Res.string.settings_sync_now),
                                color = Primary,
            ...
            AnimatedEntry(index = 3) {
                Card(
                    ...
                    Row(Modifier.padding(20.dp), verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Spacer(Modifier.width(16.dp))
                        Column(Modifier.weight(1f)) {
                            Text(stringResource(Res.string.settings_drive), style = MaterialTheme.typography.titleMedium, color = TextPrimary)
                            Text(
                                stringResource(Res.string.settings_drive_sub),
                                style = MaterialTheme.typography.bodySmall,
                                color = TextMuted
                            )
                        }
                        ...
                        Text(stringResource(Res.string.settings_soon), style = MaterialTheme.typography.labelMedium, color = TextMuted)
                    }
                }
            }
            ...
            AnimatedEntry(index = 4) {
                Button(
                    ...
                    Text(stringResource(Res.string.settings_sign_out), style = MaterialTheme.typography.labelLarge)
                }
            }
